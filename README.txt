...
What's going on:
Given 40 artists, randomlly generate connections between then.
Then allow the user to pick a start and end artist.  After that,
well, we run though the algorithim and show the user the shortest
path available.
